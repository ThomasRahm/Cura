...
UM.Dialog
{
    ...
    ListView
    {
        ...
        model: UM.SettingDefinitionsModel
        {
            ...
            exclude:
            {
                var excluded_settings = [ "machine_settings", "command_line_settings", "support_mesh", "anti_overhang_mesh", "cutting_mesh", "infill_mesh", "cradle_modifier_mesh", "anti_support_mesh", "support_mesh_drop_down"]
